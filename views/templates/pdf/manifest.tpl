...
{if isset($manifests[0])}
    ...
    {foreach from=$manifests item=manifest}
        ...
        {if isset($manifest.vendor_amount)}
        ...
        <table class="info-table">
            ...
            <tbody>
                ...
                {foreach from=$manifests item=manifest}
                    <tr>
                        <td width="20%" class="text-center">
                            <strong>#{$manifest.order.reference}#{$manifest.orderDetail.id}</strong>
                        </td>
                        <td width="30%">
                            {$manifest.orderDetail.product_name}
                        </td>
                        <td width="15%" class="text-center">
                            {if isset($manifest.orderDetail.product_reference) && $manifest.orderDetail.product_reference}
                        ...
                        <td width="5%" class="text-center">
                            <strong style="font-size: 12px;">{$manifest.orderDetail.product_quantity}</strong>
                        </td>
                ...
                <tr class="total-row">
                    ...
                    <td class="text-right">{$calculated_total_value|unescape:"htmlall"}</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="pickup-box">
        <div class="pickup-label">INSTRUCTIONS D'EMBALLAGE ET DE LIVRAISON :</div>
    <table style="width: 100%;">
        <tr>
            <td width="50%" style="vertical-align: top;">
                <strong>Exigences d'Emballage :</strong>
                    <ul style="margin: 5px 0; padding-left: 15px; font-size: 11px;">
                        <li>Chaque article doit être emballé individuellement</li>
                        <li>Articles fragiles clairement marqués</li>
                        <li>Référence de commande sur chaque colis</li>
                        <li>Manipuler avec précaution pendant le transport</li>
                    </ul>
                </td>
                <td width="50%" style="vertical-align: top;">
                    <strong>Notes de Livraison :</strong>
                    <ul style="margin: 5px 0; padding-left: 15px; font-size: 11px;">
                        <li>Livraisons séparées pour chaque client</li>
                        <li>Vérifier les détails du client avant livraison</li>
                        <li>Obtenir confirmation de signature</li>
                        <li>Retourner les articles non livrés au dépôt</li>
                    </ul>
                </td>
            </tr>
        </table>
    ...
    <div class="pickup-box">
        <div class="pickup-label">INSTRUCTIONS SPÉCIALES ET NOTES :</div>
        <div style="height: 80px; border: 1px solid #ccc; background-color: #fff; margin-top: 10px; padding: 5px;">
            ...
            {else}
                <p style="margin: 5px; font-size: 11px; color: #666; font-style: italic;">
                    Aucune instruction spéciale. Les procédures standard de ramassage et de livraison s'appliquent.
                </p>
            {/if}
        </div>
    </div>
        ...
        <tr>
            <td width="33%" style="text-align: center;">
                ...
                <div class="signature-box">
                    ...
                    <small>Articles préparés et prêts</small>
                </div>
            </td>
            <td width="33%" style="text-align: center;">
                <div style="height: 60px; border-bottom: 2px solid #000; margin-bottom: 5px;"></div>
                <div class="signature-box">
                    ...
                    <small>Articles collectés</small>
                </div>
            </td>
            <td width="33%" style="text-align: center;">
                <div style="height: 60px; border-bottom: 2px solid #000; margin-bottom: 5px;"></div>
                <div class="signature-box">
                    ...
                    <small>Heure réelle de collecte</small>
                </div>
            </td>
        </tr>
    </table>
